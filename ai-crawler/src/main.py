...
def parse_args():
    """CLI 인자 파싱"""
    parser = argparse.ArgumentParser(description="EduFit AI Crawler")
    parser.add_argument(
        "--mode",
...
async def main():
    ...
    logger.info("=" * 60)
    logger.info(f"EduFit AI Crawler Starting... (mode={mode})")
    logger.info("=" * 60)
    ...
    logger.info("EduFit AI Crawler stopped.")
